...
def upload_file(file_path, s3_path, start_dir):
    ...
    """
    print(start_dir, file_path, "hekldsmflkdasjflkdfsjd")
    try:
...
def upload(name, s3_path, data):
    s3_client.create_bucket(Bucket=bucket_name)
    dir = f'{data}/snapshots/{name}'
    print(dir, 'fuck')
    files_to_upload = get_all_files(dir)
    upload_files_in_parallel(files_to_upload, s3_path, dir)

# /home/baibhav/Downloads/prometheus_new/prometheus-2.52.0.linux-amd64/data/
# upload('20240708T085149Z-27b79b8f04946159','localhost:9090/20240708T085149Z-27b79b8f04946159', '/home/baibhav/Downloads/prometheus_new/prometheus-2.52.0.linux-amd64/data')